/*
  ...
  2. Not owned - The pointer is not owned and behaves like a raw pointer.

  This allows an instance of a class holding such a pointer to be oblivious as to whether or not it
  is the de-facto owner of the pointer. It is up to the caller who instantiated the class to decide
  whether ownership is bestowed upon the instance or not.
